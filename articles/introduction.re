...
こんなふうに日常生活の中で何かをつたえる「手段」としての文章は、詩や小説とった文学作品の文章とは区別して@<ttb>{実用文}と呼ばれています。@<code>{実用}的な@<code>{文}章なので実用文ですね。
...
//footnote[shigoto][エンジニアリングの技術を学んでシステムを開発する人たちが「エンジニア」であるように、テクニカルライティングの技術を学んで実用文を分かりやすく書く人たちは「テクニカルライター」です。テクニカルライターは、厚生労働省による職業情報提供サイトにも載っています。 @<href>{https://shigoto.mhlw.go.jp/User/Occupation/Detail/358}]

テクニカルライターは、もともとは家電や電化製品の取扱説明書を書く人たちでした。ですが近年はそこから広がって、IT系の企業で技術ドキュメントやAPIリファレンスなどを書く専門職としてテクニカルライターが採用されるようになっています。

筆者はもともとWeb制作会社のインフラエンジニアでしたが、2019年からはIT系の企業でテクニカルライターをしています。転職をした当時はテクニカルライターという職業があること自体が業界の中でもほとんど知られていませんでしたが、そこから約5年が経ってテクニカルライターを募集しているIT系の企業が段々と増えてきたことを感じます。

本書はテクニカルライターである筆者が、テクニカルライティング技術の中でも普段から特に気をつけているいくつかのコツをご紹介するものです。「文章の書き方」を解説した書籍でよく見かける文法的な話だけではなく、実際に書いていて悩みがちな部分にスポットを当てて、できるだけ実践的な内容を紹介しています。@<fn>{Technic}

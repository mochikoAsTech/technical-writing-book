...
エンジニアリングの技術を学んで、システムを開発する人たちが「エンジニア」であるように、テクニカルライティングの技術を学んで、分かりやすい実用文を書くことを生業としている人たちは「@<ttb>{テクニカルライター}」です。

厚生労働省による職業情報提供サイト@<fn>{shigoto}では、テクニカルライターは別名「マニュアルライター」とも紹介されており、もともとは家電や電化製品を買うと付いてくる、マニュアルや取扱説明書を書いている人たちがテクニカルライターと呼ばれていました。近年はそこから転じて、IT系の企業において開発ドキュメントやAPIリファレンスなどを書くテクニカルライターや、ウェブサービスのUI文言などを担当するUXライターといったポジションの募集も増えてきています。

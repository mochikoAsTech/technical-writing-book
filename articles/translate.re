...
原文と思われる英語@<fn>{original}を確認してみると、どうやらTerminateとDeleteという2つの単語を、どちらも「削除」と訳したことで生まれてしまった悲しい日本語だったようです。
...
前述のとおり、OSSのドキュメントや技術書などを英語から日本語に翻訳する場合、元の「言いたいこと」や前後の文脈をどこまで汲めたかが翻訳文の分かりやすさに直結します。そのため、ことITの分野においては翻訳に必須な力は対象技術の知識、実際に触ったことがある深度の深い理解であって、日本語の文章力や、英語の文章力はその次だと筆者は思っています。もし技術力はあっても、英語が不得手だからとドキュメントや技術書の翻訳協力に尻込みをしていたら、ぜひ一歩踏み出してみてください。

翻訳する人は「文脈が分かっている」と非常に強いです。そもそも何の話か分かっているから、原文が多少説明不足でも元の「言いたいこと」を推察してピントの合った翻訳ができます。

ドキュメントや技術書を翻訳するとき、英語が読めても「何を言っているのか」が分からないと、文法があっているだけで正しいことを何も伝えない、きれいで誤った翻訳文になりがちという自省があります。
...
ATOKは、たとえば「ほうこくはいじょうです」という入力を、「報告は以上です」という漢字とかなが交ざった文に変換する部分を担うツールです。もともとWindowsやMacにはデフォルトでMicrosoft IMEなどのIME@<fn>{ime}が入っていますが、性能や精度はそこそこなので、平気で「報告は異常です」といった意図しない変換をかましてきます。ストレスなく文章を書くための投資だと思って、その辺りの変換が非常に賢いATOKにお金を払うときっと期待以上のリターンが得られます。
...
また単語の意味や使い方を確認したいときは、調べたい言葉を選択してctrlキーを2回押すことで、すぐに広辞苑、大辞林、ウィズダム英和辞典、ウィズダム和英辞典といった辞書の最新版が引けます。（@<img>{confidence}）
...
日本だと例示（Example）の略で@<code>{ex.}と書く人が多いですが、exは「前の彼女」を「ex-girlfriend」と言ったりするときの「前の」の意味なので、例を表すときは@<code>{e.g.}を使いましょう。

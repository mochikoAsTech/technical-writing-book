...
日本だと例示（Example）の略で@<code>{ex.}と書く人が多いけど、exだと「前の彼女」を「ex-girlfriend」って言ったりするときの「前の」の意味なのでe.g. の方がよさそう。

@<code>{e.g.}はラテン語で「例えば」という意味の@<code>{exempli gratia}の略。

== 機械翻訳があれば英語がまったく分からなくても訳せるか

ChatGPTもDeepLも、しれっと真逆の意味に翻訳したり、間の文章を一文落としてきたり、逆に2回繰り返して訳してきたりする。

機械翻訳はあくまで電動自転車みたいなもので、自力ではまったく自転車が漕げないという人が乗ると事故る。なので乗ってはいけない。

...
Suggestionを使うと現状に対して期待値@<fn>{asis}を明確に提示できて、相手の修正にかかるコストも下げられるので、とってもお勧めです。逆にどう直すべきかという具体案は思いつかないけど、「分かりにくいよ！」という気持ちだけ伝えたい、というときは、前述のように重要語がNitpickingであることを書き添えた上で「こういう風に自分は分かりにくいと感じたけど、具体的な代替案は思いつかなかった」と気持ちだけ伝えてもいいでしょう。

//footnote[asis][筆者の周囲では、変更前の現状を@<code>{as-is}、変更後のあるべき姿を@<code>{to-be}と表現することがよくあります。「こう直してほしい」という意図を伝えるときのラベルとしてとても便利です。]

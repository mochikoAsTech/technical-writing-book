...
文章のレビューという工程において、レビュアー（レビューする側）とレビュイー（レビューしてもらう側）の共通目的は「@<ttb>{これをもっとよい文章にして早く世に出すこと}」です。レビュアーの目的は、決して「間違いの多い低品質な文章だったとレビュイーに自覚させること」や「強い言葉でレビュアーを傷つけて反省させること」ではありません。文章を読んで指摘をするレビュアーがこんなことに気をつけると、指摘を受け止めるレビュイーとよいコミュニケーションがとれますよ、というコツを紹介していきます。
...
レビュアーは、自分がした指摘が@<ttb>{「具体的にどう直すべきか」が読み取れない指摘}になっていないか、あるいは文章をよくすることではなく相手を傷つけることを目的とした攻撃になっていないか気をつけましょう。
...
本来は、文章を書いたレビュイーも、それを読んで指摘したレビュアーも、「もっとよい文章に早く辿り着きたい」、つまり今が6階に居るとしたら早く完成度100%の10階に行きたい、という共通の目的があるはずです。であれば、レビュイーが「直すべきということはつたわってきたけど、具体的にどう直したらいいのか分からない……」と6階で延々と考え込んでしまって時間を無為に使うのは、レビュアーにとっても嬉しいことではないはずです。
...
「A is B」って書いてあるけれどAはCなのでこれは明確な誤りだな、と思ったら「AはBではありません」とコメントするのではなく、次のようなSuggestionを書いてあげることで、レビュイーに対してどう直すべきかが過不足なくつたわると共に、レビュイーはワンクリックで修正提案を取り込むことができます。
...
Suggestionを使うと現状に対して期待値@<fn>{asis}を明確に提示できて、相手の修正にかかるコストも下げられるので、とってもお勧めです。逆にどう直すべきかという具体案は思いつかないけど、「分かりにくいよ！」という気持ちだけつたえたい、というときは、前述のように重要度がNitpickingであることを書き添えた上で「こういうふうに自分は分かりにくいと感じたけど、具体的な代替案は思いつかなかった」と気持ちだけつたえてもいいでしょう。

//footnote[asis][筆者の周囲では、変更前の現状を@<code>{as-is}、変更後のあるべき姿を@<code>{to-be}と表現することがよくあります。「こう直してほしい」という意図をつたえるときのラベルとしてとても便利です。]

=== レビューは「相手のやることを増やす」責任を持ってつたえよう
...
//footnote[comment][作品を持ち込んでは編集者にダメ出しされることの繰り返しで、何をどう直したら編集会議を通過して掲載されるのか分からない……と心が折れてしまった漫画家や小説家の話を読むと、ジャンルは全然違うけどたぶん同じような状態なんだろうなと思っています。]

レビューをするとき、レビュアーは、その修正指示が@<ttb>{「早く世に出る」という価値を毀損してまで、いまやるべきことなのか}を自分にきちんと問いましょう。
...
大量に赤を入れることがレビュアーの存在意義ではありません。繰り返しになりますが、@<ttb>{よい文章を早く世に出すことがレビュアーとレビュイーの共通目的}であると心得ましょう。
...
こういうときはこう書きましょう、というライティングのスタイルガイドやルールが存在していて、既に方針が決まっているものであれば意見は割れません。ですが、まだルールや方針が決まっていないものについて意見が割れ、さらにレビュアーのA案もレビュイーのB案もそれぞれメリットデメリットがあって一概に「こっちが正解だ！絶対にこっちの書き方の方がいい！」と言えないときは、どう直すのかなかなか両者間で折り合いがつきません。

方針を決めないと直せない→直せないといつまでもリリースできない→でも方針がなかなか決まらない、という状態は非常に苦しいです。そこでお勧めは「@<ttb>{方針を決めるのは別の機会にする}」という方法です。

組織の中で「レビューの観点を相談して方針を決める会」を毎月の繰り返し予定で入れておき、日々のレビュー指摘の中で「これ、そういえばどうするかという方針が決まってなかったね」というものが出てきたら、次回の議題に入れて「いったんこの文章は現行のままで行きましょう。次回の方針を決める会で方針が決まったら別途対応しましょう」とします。

これによってルールや方針が決まっていなくて意見が割れるものがあったとき、決まるまで進めなくて苦しくなっていたのが、次回の議題に積んでおいてさっと公開に進めるようになります。
...
レビュアーは様々な配慮をしながらレビューをしてくれています。できるだけレビューがスムーズに進むよう、レビュイーもレビュアーに歩み寄りましょう。
...
先日、「突然画力が伸びだした時、僕が発見した事」というnote@<fn>{note}を読みました。内容をざっくりまとめると、絵を描いている途中で「あ、ここおかしいから直した方がいいな」と思う箇所を見つけたときに、人間の習性なのか素直にさっと直さずに「もう〆切まであんまり時間もないし」「ここまで割とうまく描けてるし、下手に直すといまより悪くなるかも」のように、なんとかして直さないで済む理由を見つけてそのままでいきたくなってしまう。けれどその気持ちをぐっと押し込めてすぐに直すようにしたら画力が伸びた、というものでした。
...
うんうん唸りながらやっと書き上げたドキュメントや技術ブログに、指摘のコメントをもらうと、その瞬間、「指摘してもらってありがたいな」という気持ちと同時に、「いやいやこういうふうに書いた意図があるので、ここはこのまま直したくないです」という気持ちが湧き上がります。もちろん明らかな間違いであればすぐに直しますが、「そこはどっちでもよくない？好みの問題では？」というときは特に、指摘されたことを直すべきか、直さずにそのままでいくべきか、迷ってしまう人は多いのではないかと思います。

筆者も含め、レビュイーはレビュアーからの指摘を見ると、なんだかんだ言い訳をして取り込まない方向に持っていきたくなる習性がありますが、そういうときは次の2つに時間をかけるのをやめて、指摘されたところをさっと直すようにしてみてください。
...
指摘された瞬間は「えー、今のままでいいじゃん！直したくないなー！」と心から思うんですが、直した結果、「やっぱり直さなきゃよかった」と思うことは基本的にありません。お風呂に入る前は面倒くさいと思っていても、入った後に「入らなきゃよかった」とは絶対にならないのとよく似ています。「直したくないな」と思っていても、直すとちゃんと前よりもいい文章になることの方が圧倒的に多いのです。

=== レビュアーが気付いたことに、書いたとき気付けなかったのは当然
...
レビュイーはレビュアーから指摘を読んで、「俺はなぜ……これを書いたときに気付かなかったんだ……こんなにはっきり間違えているのに……」と己の目の節穴さに落ち込む必要はありません。使えるリソースが違うので、@<ttb>{レビュアーが気付いたことに、書いた時点で気付かなかったのはある意味当然}と言えます。

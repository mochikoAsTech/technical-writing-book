...
レビューには「文章をよくする」といういい面だけでなく、「相手（レビュイー）のやることを増やす」「早く出るという価値を損なう」というように足を引っ張る面もあります。なんでもかんでも気軽に放言せず、私は今から相手のやることを増やすのだ！公開を遅らせてでもここは直した方が絶対にいいんだ！という責任を持って指摘を伝えるか、前述のような重要度を添えて取り込む取り込まないを相手が選べるようにしてあげましょう。
...
どちらにせよ、指摘することが少なかったときに、粗探しをして無理矢理指摘をひねり出す必要はありません。何か指摘をひねり出そうとせず、素直に「分かりやすく書けていたので修正して欲しいところは殆どありませんでした。気づいたことはこれだけです」と伝えてレビュー結果をレビュイーに渡しましょう。
...
モンティ・ホール問題@<fn>{monti}と同じで、他の人が書いた技術記事に対して「もっとこうすればよかった」「技術的に誤りがある」と指摘するのは、基本的に後だしじゃんけんです。あなたが0から書いていたら、もっと別の誤りを仕込んでいたかもしれないし、そもそも書けずに挫折していたかもしれません。レビュアーは初稿を書いた人よりも、そもそも優位な立場であることを自覚したうえで指摘をすべきです。

//footnote[monti][プレーヤーの前に3つの扉があり、そのうちどれか1枚だけが当たりである。プレーヤーが1つの扉を選んだ後、司会者が残った2枚の扉のうち片方を開けてそこが外れだったことを示す。司会者がプレーヤーに「最初に選んだ扉か、残っているもう1枚の扉か、選び直していい」と言うが、このときプレーヤーは選んだ扉を変えるべきか否か、という問題。ちなみに選び直すのが正解。なぜなら最初に選んだ扉は3枚のうち1枚だったので当たりの確率は3分の1。それに対して残っている扉が2枚の状態で選び直せば当たりの確率は2分の1なので、残っている扉を選び直した方が当たる確率が高い。]

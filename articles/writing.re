...
あなたがこれから書く文章は誰に向けたものなのか、を最初にしっかり決めておかないと、のちのち「どこまでさかのぼって説明しないとだめなんだ……？」と頭を抱えることになったり、あるいは読者に「こんな簡単なことはもう知っている。もっと踏み込んだ内容が読めると期待していたのに」と不満を持たれたりします。
...
この大枠からはじめるという順番を無視して、たとえば「ババ抜きから派生したゲームでジジ抜きもある」のような細かい話から書いてしまうと、読み手は全体像が分かっていないので混乱します。
...
こんなふうにいちばんよい一文を探してああでもないこうでもないと長時間悩んでしまう人には、たくさんのパターンを並べて書き、その中から最善案を見つけるという方法がお勧めです。
...
//footnote[link][@<href>{https://salon.mainichi-kotoba.jp/archives/50189}]

URLを誰かに教えてあげるためにコピーして貼り付けるときなら、「Slackのチャンネルに興味深い記事のURLを貼る」のように「貼る」を使うのがいいでしょう。これは他の人に「こういう記事があったよ」と知らせるために、URLの書かれた紙を壁に糊で貼り付けるようなイメージです。

一方、「商品一覧から詳細ページにリンクを張る」のような場合は「張る」を使います。これは蜘蛛がこちらからあちらへ糸を張るように、いま見ているページから別のページへ繋げる糸をピンと張っているイメージです。

...
書き上げるまでの速度が速いと、それだけ見直しやレビューに時間がかけられるので、最終的にできあがる文章の品質も上がります。「書くぞ！」と思ってから文章を書き上げるまでを速くするコツがいくつかあります。
...
包丁すら握ったことがない人が、いきなりフレンチのフルコースを作ろうとすれば大抵は失敗します。それと同じで、短い文章すら書き慣れていないのにいきなり壮大なドキュメントを書こうとすると、うまくいかずに挫折してしまうことが多いです。

まずはトマトを切って塩を振っただけのものを毎日作ってみる。それがうまくできるようになったら、トマトときゅうりを切ってサラダにしてみる。それも慣れてきたらサラダとは別に肉を焼いてみたり、ご飯も炊いてみたりする。そこまできたらついに献立を考えて朝昼晩の食事を作ってみる、というように意識してゆっくり難易度を上げていく必要があります。

...
たとえば「ブラウザでwww.example.comを開くと、名前解決が行なわれてウェブサーバの203.0.113.222というIPアドレスが返ってきます」というように、技術の説明をしていると具体的なIPアドレスやドメインを書きたくなることがあります。このようなときは@<ttb>{例示用のドメインやIPアドレスを使いましょう}。

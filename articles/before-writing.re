...
実用文は詩や小説とは異なる、という話は理解しやすいと思います。その一方で、一見すると実用文のようですがテクニカルライティングの技術だけでは書けないものもあります。それが次の2つです。

 * 法務文書
 ** 特殊な専門性に基づいて書かれる法務文書は、優先事項がテクニカルライティングとは異なります。法令遵守が最優先であり、読みやすさや簡潔さはさほど重視されません。
 * 広告やキャッチコピー
 ** 読み手に強烈な印象を残して購買に繋げることを重視するため、間違った言い回しや誤解を生む表現が正解になり得ます。

テクニカルライティングという名前だけを聞くと、なんとなく「利用規約をレビューする」「製品のよさをつたえるキャッチーな見出しを書く」といったことにも使えそうな気がしてしまいますが、法務文書や広告は他の実用文と善し悪しの物差しが異なります。テクニカルライティングはあくまで@<ttb>{実用文を分かりやすく書く}ための技術であり、ありとあらゆる場面でこの書き方が常に正解という訳ではありません。
...
「割と知っている」「結構分かっている」はずの技術について本やブログを書こうとしたとき、書く前はラクに書ける気がするのに、実際書き始めるとなぜ書けないのか……と悩んだことがありませんか？既に使ったことがあり、分かっている技術であっても、理解の解像度が高くないと筆がなかなか進みません。
...
それから@<ttb>{「間違ったことを書くのは怖いので○○についてもっと詳しくなったら書こう」と思っていると一生書けません}。なぜなら書きはじめてようやく「あ、この辺の知識が抜けている」という不足に気付くからです。人間は書くことで初めて「○○について詳しくなる」という階段を上り始めます。それに何かを誤解しているとき、そもそも自分ではそれが誤解だと気付いていないので、目に見える形で自分の理解を外に出して誰かに指摘してもらわない限り「自分が誤解している」ということにも気づけません。

...
つまり実用文とは、@<ttb>{対象となる「何か」について論理的かつ簡潔に説明をしていてそれを読むことで何をどうすればいいのかが分かるような文章}ということですね。実用文では、文学作品とは違って「流れるような文体」や「人の心を揺さぶる表現」は必要ありません。
...
テクニカルライティングという名前だけを聞くと、なんとなく「利用規約をレビューする」「製品のよさをつたえるキャッチーな見出しを書く」といったことにも使えそうな気がしてしまいますが、これらのように目指すべき成果物が異なるものもあります。テクニカルライティングはあくまで@<ttb>{実用文を分かりやすく書く}ための技術であり、ありとあらゆる場面でこの書き方が常に正解という訳ではありません。
...
もともと自転車に詳しい人を除いて、恐らくはほとんどの人はこんな感じの「えー、自転車ってこんなだっけ？」という絵が出来上がったことと思います。

では正しい自転車の絵を見てみましょう。（@<img>{correct-bicycle}）
...
「分かっているはずの技術なのに、自分は言葉にするのが下手でなかなかうまくつたえられない」そんなとき実は不足しているのは出力の部分ではなく、入力や理解の部分なのかもしれません。「書こうとするとなぜか筆が進まず、頑張って書いてもふわっとした説明になってしまう……」と思ったら、そのもやもやっとした部分だけ理解の解像度が低くなっていることを疑って、改めて対象の理解に努めてみましょう。
...
レゴブロック@<fn>{lego}と同じで、少ないパーツで何か作れと言われると難易度が高くなります。「この言い回し」とか「こういう表現」とか「こんな説明の仕方」というようないいパーツ、あるいは「こういう構成」や「こんな順番」といったいい組み合わせの例が自分の中にいっぱいあると、それだけ「いい文章」が組み立てやすくなります。
